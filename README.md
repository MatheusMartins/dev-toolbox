...
A collection of tools for developers and operations analysts.
...
This is a small repo that I use for personal development. No more tools are planned. Otherwise, here's a few resources I'd like to study more in depth and apply to this project:

- Learn about types: https://svelte.dev/docs/kit/types#app.d.ts
